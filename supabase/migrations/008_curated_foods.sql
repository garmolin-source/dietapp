-- ============================================================
-- Migration 008: Replace USDA data with curated Diet Angel food DB
-- Generated: 2026-03-20
-- 347 foods: 252 Claude-curated + 95 Israeli brands
-- Stars are accurate per the official Diet Angel system
-- ============================================================

BEGIN;

-- Remove all AI-imported foods from migration 007 (USDA data)
-- Manual/seed foods are kept (source = 'manual' is kept, only 'ai_agent' removed)
DELETE FROM public.food_portions
WHERE food_id IN (
  SELECT id FROM public.foods WHERE source = 'ai_agent'
);
DELETE FROM public.foods WHERE source = 'ai_agent';
