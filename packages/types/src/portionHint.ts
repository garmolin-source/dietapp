/**
 * Returns a real-life visual size reference for a portion in Hebrew.
 * Helps users estimate "what does 300g of chicken actually look like?"
 */
export function getPortionVisualHint(category: string, grams: number | null | undefined): string | null {
  ...
  switch (category) {
    case 'protein': {
      // Reference: palm of hand ≈ 85–100g of meat/fish
    ...
    case 'carb': {
      // Reference: handful of cooked grains ≈ 80–100g
    ...
    case 'dairy': {
      // Liquids/semi-liquids — cup reference (240ml ≈ cup)
    ...
    case 'fat': {
      // Nuts, oils, spreads — tablespoon ≈ 15g
